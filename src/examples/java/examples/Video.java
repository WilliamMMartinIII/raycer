...
public class Video {
    ...
    public static void main(String[] args) {
        ...
        IMediaWriter videoWriter = ToolFactory.makeWriter("normalTest.mp4");
        ...
        double[] cameraPostiion = scene.cameraPosition;

        camera.setUp();
        for (int i = 0; i < scene.LENGTH * scene.FRAME_RATE; i++) {
            cameraPostiion[0] = i / (scene.LENGTH * scene.FRAME_RATE) * 2.0 - 1.0;
